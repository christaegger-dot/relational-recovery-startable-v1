...
export default function GlossaryPageTemplate({ hero, pageHeadingId, intro, groups = [] }) {
  return (
    <div className="ui-stack">
      <Container width="wide">
        <PageHero {...hero} headingId={pageHeadingId} />
      </Container>
      <GlossaryIntro intro={intro} />
      <GlossaryIndex groups={groups} />
      {groups.map((group) => (
        <GlossaryGroup key={group.id} group={group} />
      ))}
    </div>
  );
}
